                    ...
                    <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
                        <div class="single-product-box one">
                            <div class="big-product single-product-one slider-for">
                                <div>
                                    <div class="single-item"> <img src="/src/assets/images/shop/products-img1.jpg" alt="">
                                        <div class="ptag"> <span class="one">-20% </span> </div> <a href="#0"
                                            class="love"> <i class="flaticon-like"></i> </a>
                                    </div>
                                </div>
                                <div>
                                    <div class="single-item"> <img src="/src/assets/images/shop/products-img2.jpg" alt="">
                                        <div class="ptag"> <span class="one">-20% </span> </div> <a href="#0"
                                            class="love"> <i class="flaticon-like"></i> </a>
                                    </div>
                                </div>
                                <div>
                                    <div class="single-item"> <img src="/src/assets/images/shop/products-img3.jpg" alt="">
                                        <div class="ptag"> <span class="one">-20% </span> </div> <a href="#0"
                                            class="love"> <i class="flaticon-like"></i> </a>
                                    </div>
                                </div>
                                <div>
                                    <div class="single-item"> <img src="/src/assets/images/shop/products-img4.jpg" alt="">
                                        <div class="ptag"> <span class="one">-20% </span> </div> <a href="#0"
                                            class="love"> <i class="flaticon-like"></i> </a>
                                    </div>
                                </div>
                                <div>
                                    <div class="single-item"> <img src="/src/assets/images/shop/products-img5.jpg" alt="">
                                        <div class="ptag"> <span class="one">-20% </span> </div> <a href="#0"
                                            class="love"> <i class="flaticon-like"></i> </a>
                                    </div>
                                </div>
                            ...
                            <div class="navholder">
                                <div class="product-slicknav single-product-one-nav slider-nav">
                                    <div> <span class="single-item"> <img
                                                src="/src/assets/images/shop/shop-details-top-img-1.png" alt=""> </span>
                                    </div>
                                    <div> <span class="single-item"> <img
                                                src="/src/assets/images/shop/shop-details-top-img-2.png" alt=""> </span>
                                    </div>
                                    <div> <span class="single-item"> <img
                                                src="/src/assets/images/shop/shop-details-top-img-3.png" alt=""> </span>
                                    </div>
                                    <div> <span class="single-item"> <img
                                                src="/src/assets/images/shop/shop-details-top-img-1.png" alt=""> </span>
                                    </div>
                        ...
                        <div class="shop-details-top-right ">
                            <div class="shop-details-top-right-content-box">
                                ...
                                <div class="shop-details-top-price-box">
                                    <h3>${{ product ? product.price : '' }} <del>$50.00</del></h3>
                                    <p>(+15% Vat Included)</p>
                                </div>
                                ...
                                <!-- <div class="shop-details-top-color-sky-box">
                                  <h4 v-for="color in groupProduct.colors">Color: Привет </h4>
                                  <ul class="color-option">
                                    <li v-for="groupProduct in product ? product.group_products : ''">
                                      <a @click.prevent="getProduct(groupProduct.id)" v-for="color in groupProduct.colors" href="#0"
                                      :style="`background: ${color.title}; color: black; padding: 1.5em 0.7em`" class="color-option-single"> </a>
                                    </li>
                                  </ul>
                                </div> -->
                                ...
                                <div class="shop-details-top-color-sky-box">
                                    ...
                                    <ul class="color-option">
                                        <li v-for="groupProduct in product ? product.group_products: ''     "> 
                                                ...
                                                <a @click.prevent="getProduct(groupProduct.id)" v-for="color in groupProduct.colors" href="#0" :style="`background: ${color.title}; color: black; padding: 1.5em 0.7em`" class="color-option-single"> </a> 
                                ...
                                <div class="product-quantity">
                                    ...
                                    <div class="product-quantity-box d-flex align-items-center flex-wrap">
                                        ...
                                        <div class="product-quantity-check"> 
                                            <i style="color: red" class="flaticon-select"></i>
                                        <p>In Stock</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product-drescription">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-4 mt-30 ">
                                        <div class="thumb"> <img
                                                src="/src/assets/images/shop/shop-details-tab-content-specification-img-1.jpg"
                                                alt=""> </div>
                                    </div>
                        ...
                        <div class="products-grid-one">
                            <div class="products-grid-one__product-image">
                                <div class="products-grid-one__badge-box"> <span class="bg_base badge new ">New</span>
                                        ...
                                        src="/src/assets/images/shop/products-img1.jpg" alt="Alt"> </a>
                                                    ...
                                                    <div class="popup-product-thumb-box">
                                                        <ul>
                                                            <li class="tab-nav popup-product-thumb"> <a href="#tab7">
                                                                    <img src="/src/assets/images/shop/products-img1.jpg"
                                                                        alt="img"> </a> </li>
                                                            <li class="tab-nav popup-product-thumb "> <a href="#tab8">
                                                                    <img src="/src/assets/images/shop/products-img2.jpg"
                                                                        alt="img"> </a> </li>
                                                            <li class="tab-nav popup-product-thumb "> <a href="#tab9">
                                                                    <img src="/src/assets/images/shop/products-img3.jpg"
                                                                        alt="img"> </a> </li>
                                                        </ul>
                                                    </div>
                                                    <div class="popup-product-main-image-box">
                                                        <div id="tab7" class="tab-item popup-product-image">
                                                            <div class="popup-product-single-image"> <img
                                                                    src="/src/assets/images/shop/products-img1.jpg"
                                                                    alt="img"> </div>
                                                        </div>
                                                        <div id="tab8" class="tab-item popup-product-image">
                                                            <div class="popup-product-single-image"> <img
                                                                    src="/src/assets/images/shop/products-img2.jpg"
                                                                    alt="img"> </div>
                                                        </div>
                                                        <div id="tab9" class="tab-item popup-product-image">
                                                            <div class="popup-product-single-image"> <img
                                                                    src="/src/assets/images/shop/products-img3.jpg"
                                                                    alt="img"> </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="popup-right-content">
                                                ...
                                                <div class="payment-method"> <a href="#0"> <img
                                                            src="/src/assets/images/payment_method/method_1.png" alt=""> </a>
                                                    <a href="#0"> <img src="/src/assets/images/payment_method/method_2.png"
                                                            alt=""> </a> <a href="#0"> <img
                        ...
                        <div class="products-grid-one">
                            <div class="products-grid-one__product-image">
                                <div class="products-grid-one__badge-box"> <span
                                    ...
                                    class="d-block products-grid__image_holder"> <img
                                        ...
                                        src="/src/assets/images/shop/products-img3.jpg" alt="Alt"> <img
                                        class="products-grid-one__hover-img" src="/src/assets/images/shop/products-img4.jpg"
                                        alt="Alt"> </a>
                                <div class="products-grid__usefull-links">
                                    <ul>
                                        <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                                                    ...
                                                    <div class="popup-product-thumb-box">
                                                        <ul>
                                                            ...
                                                            <li class="tab-nav popup-product-thumb "> <a href="#tab888">
                                                                    <img src="/src/assets/images/shop/products-img4.jpg"
                                                                        alt="img"> </a> </li>
                                                            <li class="tab-nav popup-product-thumb "> <a href="#tab999">
                                                                    <img src="/src/assets/images/shop/products-img5.jpg"
                                                                        alt="img"> </a> </li>
                                                        </ul>
                                                    </div>
                                                    <div class="popup-product-main-image-box">
                                                        ...
                                                        <div id="tab888" class="tab-item popup-product-image">
                                                            <div class="popup-product-single-image"> <img
                                                                    src="/src/assets/images/shop/products-img5.jpg"
                                                                    alt="img"> </div>
                                                        </div>
                                                        <div id="tab999" class="tab-item popup-product-image">
                                                            <div class="popup-product-single-image"> <img
                                                                    src="/src/assets/images/shop/products-img6.jpg"
                                                                    alt="img"> </div>
                                                        </div> <button class="prev"> <i class="flaticon-back"></i>
                                                        </button> <button class="next"> <i class="flaticon-next"></i>
                                                        </button>
                            ...
                            <div class="products-grid-one__thumb-box">
                                <p class="products-grid-one__product-varient"> <span class="color"> Yellow </span> <img
                                        src="/src/assets/images/shop/products-img3.jpg" alt="Alt"> </p>
                                <p class="products-grid-one__product-varient"> <span class="color"> blue </span> <img
                                        src="/src/assets/images/shop/products-img4.jpg" alt="Alt"> </p>
                                <p class="products-grid-one__product-varient"> <span class="color"> Black </span> <img
                                        src="/src/assets/images/shop/products-img5.jpg" alt="Alt"> </p>
                            </div>
                        </div>
                        <div class="products-grid-one">
                            <div class="products-grid-one__product-image">
                                <div class="products-grid-one__badge-box"> <span class="bg_base badge new ">New</span>
                                    ...
                                    href="shop-details-1.html" class="d-block products-grid__image_holder"> <img
                                        class="products-grid-one__mainimage products-grid-one__first-img"
                                        src="/src/assets/images/shop/products-img4.jpg" alt="Alt"> <img
                                        class="products-grid-one__hover-img" src="/src/assets/images/shop/products-img5.jpg"
                                        alt="Alt"> </a>
                                <div class="products-grid__usefull-links">
                                    <ul>
                                        <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                                                ...
                                                <div class="tabs">
                                                    ...
                                                    <div class="popup-product-main-image-box">
                                                        <div id="tab7777" class="tab-item popup-product-image">
                                                            <div class="popup-product-single-image"> <img
                                                                    src="/src/assets/images/shop/products-img4.jpg"
                                                                    alt="img"> </div>
                                                        </div>
                        ...
                        <div class="products-grid-one">
                            <div class="products-grid-one__product-image">
                                <div class="products-grid-one__badge-box"> <span class="bg_base badge new ">New</span>
                                        ...
                                        src="/src/assets/images/shop/products-img6.jpg" alt="Alt"> </a>
                                <div class="products-grid__usefull-links">
                                    <ul>
                                        <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                                                    wishlist</span> </a> </li>
                                                ...
                                                <div class="tabs">
                                                    <div class="popup-product-thumb-box">
                                                        <ul>
                                                            ...
                                                            <li class="tab-nav popup-product-thumb "> <a
                                                                    href="#tab99999"> <img
                                                                        src="/src/assets/images/shop/products-img7.jpg"
                                                                        alt="img"> </a> </li>
                                                        </ul>
                                                    </div>
                                                    <div class="popup-product-main-image-box">
                            ...
                            <div class="products-grid-one__thumb-box">
                                <p class="products-grid-one__product-varient"> <span class="color"> blue </span> <img
                                        src="/src/assets/images/shop/products-img6.jpg" alt="Alt"> </p>
                                <p class="products-grid-one__product-varient"> <span class="color"> Yellow </span> <img
                                        src="/src/assets/images/shop/products-img5.jpg" alt="Alt"> </p>
                            </div>
                        </div>
                        <div class="products-grid-one">
                            <div class="products-grid-one__product-image">
                                <div class="products-grid-one__badge-box"> <span class="bg_base badge new ">New</span>
                                        ...
                                        class="products-grid-one__mainimage products-grid-one__first-img"
                                        src="/src/assets/images/shop/products-img6.jpg" alt="Alt"> <img
                                        class="products-grid-one__hover-img" src="/src/assets/images/shop/products-img2.jpg"
                                        alt="Alt"> </a>
                                <div class="products-grid__usefull-links">
                                    <ul>
                                        <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                            ...
                            <div class="products-grid-one__thumb-box">
                                <p class="products-grid-one__product-varient"> <span class="color"> Blue </span> <img
                                        src="/src/assets/images/shop/products-img6.jpg" alt="Alt"> </p>
                                <p class="products-grid-one__product-varient"> <span class="color"> Yellow </span> <img
                                        src="/src/assets/images/shop/products-img7.jpg" alt="Alt"> </p>
                                <p class="products-grid-one__product-varient"> <span class="color"> green </span> <img
                                        src="/src/assets/images/shop/products-img8.jpg" alt="Alt"> </p>
                            </div>
                        </div>
                        <div class="products-grid-one">
                            <div class="products-grid-one__product-image"> <a href="shop-details-1.html"
                                    class="d-block products-grid__image_holder"> <img
                                        class="products-grid-one__mainimage products-grid-one__first-img"
                                        src="/src/assets/images/shop/products-img12.jpg" alt="Alt"> <img
                                        class="products-grid-one__hover-img" src="/src/assets/images/shop/products-img11.jpg"
                                        alt="Alt"> </a>
                                <div class="products-grid__usefull-links">
                                    <ul>
                                        <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                                                    ...
                                                    <div class="popup-product-thumb-box">
                                                        <ul>
                                                            <li class="tab-nav popup-product-thumb"> <a href="#ttab111">
                                                                    <img src="/src/assets/images/shop/products-img9.jpg"
                                                                        alt="img"> </a> </li>
                                                            <li class="tab-nav popup-product-thumb "> <a
                                                                    href="#ttab222"> <img
                                                                        src="/src/assets/images/shop/products-img10.jpg"
                                                                        alt="img"> </a> </li>
                                                            <li class="tab-nav popup-product-thumb "> <a
                                                                    href="#ttab333"> <img
                                                                        src="/src/assets/images/shop/products-img11.jpg"
                                                                        alt="img"> </a> </li>
                                                        </ul>
                                                    </div>
                                                    <div class="popup-product-main-image-box">
                                                        <div id="ttab111" class="tab-item popup-product-image">
                                                            <div class="popup-product-single-image"> <img
                                                                    src="/src/assets/images/shop/products-img9.jpg"
                                                                    alt="img"> </div>
                                                        </div>
                            ...
                            <div class="products-grid-one__thumb-box">
                                <p class="products-grid-one__product-varient"> <span class="color"> Blue </span> <img
                                        src="/src/assets/images/shop/products-img12.jpg" alt="Alt"> </p>
                                <p class="products-grid-one__product-varient"> <span class="color"> Green </span> <img
                                        src="/src/assets/images/shop/products-img11.jpg" alt="Alt"> </p>
                                <p class="products-grid-one__product-varient"> <span class="color"> Black </span> <img
                                        src="/src/assets/images/shop/products-img10.jpg" alt="Alt"> </p>
                            </div>
                        </div>
                    </div>
                </div>
