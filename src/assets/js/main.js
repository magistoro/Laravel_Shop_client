jQuery(function ($) {
  ...
  /****======  niceSelect  ======*******/  // КОД ЛОМАЮЩИЙ ПЕРЕДАЧУ ФУНКЦИИ @select !!!
  ...
  if ($(".popup_link").length) {
    ...
    // $('.popup-product-main-image-box .tab-item:not(:first)').remove();
  ...
  //     }, 100);
  //     let slidervalue = parseInt($parentElm.find(".qtyValue").val(),10);
  //     if (slidervalue < maxVal) {
  //       slidervalue++;
  //       console.log(slidervalue);
  //     }
  //     $parentElm.find(".qtyValue").val(slidervalue);
  //   });
  // };
  ...
  if ($(".increaseQty").length) {
    var maxVal = 20;
    $(".increaseQty").off().on("click", function () {
      var $parentElm = $(this).parents(".qtySelector");
      $(this).addClass("clicked");
      setTimeout(function () {
        $(".clicked").removeClass("clicked");
  ...
  if ($(".decreaseQty").length) {
    $(".decreaseQty").off().on("click", function () {
      var $parentElm = $(this).parents(".qtySelector");
      $(this).addClass("clicked");
      setTimeout(function () {
        $(".clicked").removeClass("clicked");
      }, 100);
      var slidervalue = $parentElm.find(".qtyValue").val();
      if (slidervalue > 1) {
        slidervalue--;
      }
      $parentElm.find(".qtyValue").val(slidervalue);
  ...
  $(".eye").each(function() {
    var container = $(this);
    var inputField = container.find("input[type='password']");
    
    container.find(".icon-1").click(function () {
      inputField.attr("type", "text");
      $(this).hide();
      container.find(".icon-2").css("display", "block");
    });
  
    container.find(".icon-2").click(function () {
      inputField.attr("type", "password");
      $(this).hide();
      container.find(".icon-1").css("display", "block");
    });
  });
