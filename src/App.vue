                ...
                <div class="d-lg-block d-none">
                    <div class="row g-0 position-relative">
                        <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
                            <div class="logo"> <router-link to="/"> <img src="http://localhost:5173/src/assets/images/logo/logo.png" alt=""></router-link>
                            </div>
                        </div>
                                    ...
                                    <div class="some-info">
                                        ...
                                        <div class="right d-flex align-items-center ">
                                            ...
                                            <div class="language two"> <select>
                                                ...
                                                </select> </div> <router-link to="/users/login" > Sign In /&nbsp</router-link>
                                                <router-link to="/users/registration" > Register </router-link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class=" d-flex align-items-center justify-content-between ">
                                            ...
                                            <div class="right d-flex align-items-center justify-content-end">
                                                <ul class="main-menu__widge-box d-flex align-items-center ">
                                                    <li class="d-lg-block d-none"><router-link to="/users/login"><i
                                                    ...
                                                    <li class="cartm"> <a class="number cart-icon"> <i
                                                                class="flaticon-shopping-cart"></i><span
                                                                class="count">({{ getTotalQuantity() }})</span> </a> </li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        </div> <router-link to="/cart" class="offer-link"> Offer </router-link>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="side-cart d-flex flex-column justify-content-between">
                ...
                <div class="cart_items">
                    <div v-for="product in products" class="items d-flex justify-content-between align-items-center">
                        <!-- <div class="left d-flex align-items-center"> 
                            <router-link :to="{name:'products.show', params: {id:product.id}}" class="thumb d-flex justify-content-between align-items-center" :key="product.id"> <img :src="product.image_url" alt=""> </router-link>
                            <div class="text"> 
                                <router-link :to="{name:'products.show', params: {id:product.id}}" :key="product.id">
                                    <h6>{{ product.title }}</h6>
                                </router-link>
                        ...
                        <div class="left d-flex align-items-center"> 
                          <router-link :to="{name:'products.show', params: {id: product.id}}"  class="thumb d-flex justify-content-between align-items-center">
            ...
            <div class="bottom">
                <div class="total-ammount d-flex justify-content-between align-items-center">
                    ...
                    <h6 class="ammount text-uppercase">${{  getTotalCost() }}</h6>
                </div>
            
                <div class="button-box d-flex justify-content-between">
                    <router-link to="/cart" href="cart.html" class="btn_black"> View Cart</router-link> 
                    <router-link to="/" href="cart.html" class="button-2 btn_theme"> Chekout </router-link> 
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 mt-30 wow fadeInUp animated">
                        <div class="footer-default__single-box">
                            ...
                            <ul class="footer-links">
                                ...
                                <li><router-link to="/users/login" >Sign In</router-link></li>
...
export default{
  ...
  methods: {
    ...
    watch: {
  $route(to, from) {
    if (to.name === "products.show" && from.name === "products.show") {
        // location.reload();
        this.$router.go(0);
    }
  }
